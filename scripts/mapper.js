...
async function mapCodebase(projectRoot) {
    ...
    const dimensions = [
        { id: 'ARCH', name: 'Architecture Analyst', prompt: 'Analyze patterns (MVC, microservices, etc.), module boundaries, and cross-module dependencies.' },
        { id: 'TECH', name: 'Tech Stack Detective', prompt: 'Identify languages, frameworks, build tools, test runners, and CI/CD pipelines.' },
        { id: 'DATA', name: 'Data Model Inspector', prompt: 'Analyze database schemas, ORM usage, data flows, and central API contracts.' },
        { id: 'API', name: 'API Surface Scanner', prompt: 'Map all exposed endpoints, authentication mechanisms, and external integrations.' },
        { id: 'QUALITY', name: 'Quality Auditor', prompt: 'Assess test coverage, linting status, known technical debt, and convention adherence.' }
    ];
...
`;
    ...
    for (const dim of dimensions) {
        ...
        console.log(chalk.white(`  <instruction>Update the relevant section in ${mapPath} with your findings.</instruction>`));
