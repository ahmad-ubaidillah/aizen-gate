# Aizen-Gate Playbook: az-fix (Quick Mode)
...
- If the fix touches more than 3 files or involves logic changes that could break the system, pivot to `az-specify` instead.
